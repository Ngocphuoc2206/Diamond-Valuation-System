...
const enTranslations: Record<string, string> = {
  ...
  'hero.subtitle': 'Expert diamond appraisal services with unmatched precision and trust. Discover the true value of your precious gemstones.',
  ...
  'intro.description': 'We provide expert diamond appraisal services with state-of-the-art technology and experienced specialists. Our mission is to deliver accurate, transparent, and reliable diamond valuations that help our clients make informed decisions about their precious gemstones.',

  // Services
  'service.valuation.title': 'Diamond Valuation',
  'service.valuation.description': 'Accurate diamond appraisal using advanced technology and expert analysis for insurance, resale, or personal knowledge.',
  'service.certification.title': 'Certification',
  'service.certification.description': 'Professional diamond certification services to authenticate and document the precise characteristics of your diamonds.',
  'service.consultation.title': 'Expert Consultation',
  'service.consultation.description': 'Personalized guidance from diamond specialists to help you understand your gemstone\'s quality and value.',

  // Valuation Process
  'process.title': 'Our',
  'process.titleHighlight': 'Valuation Process',
  'process.description': 'Experience our streamlined process designed to give you accurate diamond valuations with minimal wait time and maximum transparency.',
  'process.step1.title': 'Submit Request',
  'process.step1.description': 'Fill out our detailed online form with information about your diamond. Include as many details as you have, such as certification, origin, and physical characteristics.',
  'process.step2.title': 'Consultation',
  'process.step2.description': 'Our consulting staff will contact you to discuss your valuation needs and arrange for your diamond to be examined by our experts.',
  'process.step3.title': 'Expert Valuation',
  'process.step3.description': 'Our gemologists perform a comprehensive analysis using advanced equipment to assess all aspects of your diamond according to international standards.',
  'process.step4.title': 'Receive Certificate',
  'process.step4.description': 'Get your comprehensive valuation certificate with all details about your diamond\'s characteristics, quality, and estimated value in current market conditions.',
  'process.startNow': 'Start Your Valuation Now',

  // Featured Diamonds
  'featured.diamonds.title': 'Featured',
  'featured.diamonds.titleHighlight': 'Diamonds',
  'featured.diamonds.description': 'Explore our collection of extraordinary diamonds, each with unique characteristics and exceptional beauty.',
  ...
  'knowledge.description': 'Everything you need to know about diamonds, from the basics of the 4 Cs to advanced gemological insights and market trends.',
  ...
  'knowledge.featuredDescription': 'Start with these essential guides to understanding diamonds and their valuation.',
  ...
  'cta.description': 'Start your diamond valuation journey today with our expert team and receive a comprehensive assessment of your precious gemstone.',
  'cta.getStarted': 'Get Started Now',

  // Footer
  'footer.description': 'Your trusted partner for diamond valuation, certification, and expertise in the world of luxury gemstones.',
  ...
  'footer.newsletterDescription': 'Subscribe to our newsletter for the latest diamond trends and valuation insights.',
  ...
  'valuation.tool': 'Tool',
  'valuation.description': 'Get an estimated value for your diamond by providing its characteristics. Complete the form below for a professional valuation.',
  'valuation.step': 'Step',
  'valuation.of': 'of',
  ...
  'step1.description': 'Enter your diamond\'s certificate information if available, or proceed without it.',
  ...
  'step1.note': 'Note: By providing a certificate number, we may be able to retrieve some information automatically, which will help in the valuation process.',
  ...
  'step3.description': 'These important characteristics significantly impact your diamond\'s value.',
  'step3.colorGrade': 'Color Grade',
  'step3.clarityGrade': 'Clarity Grade',
  'step3.didYouKnow': 'Did you know?',
  'step3.didYouKnowText': 'Color and clarity are two of the "4 Cs" that determine a diamond\'s value. The color scale ranges from D (colorless) to Z (light yellow or brown), while clarity measures the absence of inclusions and blemishes, ranging from Flawless (FL) to Included (I3).',

  'step4.title': 'Cut Characteristics',
  'step4.description': 'The cut quality significantly affects how light interacts with your diamond.',
  ...
  'step5.description': 'If known, please provide the physical dimensions of your diamond.',
  'step5.length': 'Length (mm)',
  'step5.width': 'Width (mm)',
  'step5.depth': 'Depth (mm)',
  'step5.guide': 'Diamond Dimensions Guide',
  'step5.guideTip': 'Accurate measurements help provide a more precise valuation, especially when combined with weight and other characteristics.',

  'step6.title': 'Additional Information',
  'step6.description': 'Any other details that might affect your diamond\'s valuation.',
  ...
  'step6.notesPlaceholder': 'Any other details about your diamond that might be relevant for valuation...',
  'step6.helpfulTip': 'Helpful Tip',
  'step6.helpfulTipText': 'If your diamond is in a setting, please note that we provide separate valuations for the diamond and the setting. If you\'re interested in a valuation of the entire piece of jewelry, please specify this in your additional notes.',

  'step7.title': 'Contact Information',
  'step7.description': 'Please provide your contact details so we can deliver your valuation results.',
  ...
  'results.noteText': 'This is an automated estimate based on the information provided. For a precise valuation, we recommend scheduling a professional in-person assessment with our expert gemologists.',
  'results.summary': 'Your Diamond Summary',
  'results.nextSteps': 'Next Steps',
  'results.requestSubmitted': 'Your valuation request has been submitted successfully! A member of our team will contact you at {email} within 24 hours.',
  ...
  'placeholder.handlingInstructions': 'Any special handling instructions or notes for the valuation staff...',
  ...
  'shop.description': 'Discover our exquisite collection of certified diamonds and luxury jewelry pieces, each one carefully selected for its exceptional quality and beauty.',
  ...
  'shop.needHelpDesc': 'Our diamond experts are here to help you find the perfect piece. Get personalized recommendations and professional guidance.',
  ...
  'faq.description': 'Find answers to common questions about diamond valuation, our services, and the appraisal process.',
  ...
  'faq.diamondGradingDesc': 'Learn about the 4 Cs and how we evaluate diamond quality and characteristics.',
  'faq.pricingFeesDesc': 'Understand our transparent pricing structure and what\'s included in each service.',
  'faq.certificatesDesc': 'Information about diamond certificates and how they affect valuation.',
  'faq.shippingSafetyDesc': 'Safe shipping practices and insurance coverage for your valuable items.',
  'faq.viewQuestions': 'View questions →',
  'faq.readyToStart': 'Ready to Get Started?',
  'faq.readyToStartDesc': 'If you didn\'t find the answer you\'re looking for, our expert team is here to help you with personalized assistance.',
  ...
  'faq.topics.diamondGradingDesc': 'Learn about the 4 Cs and how we evaluate diamond quality and characteristics.',
  'faq.topics.pricingFees': 'Pricing & Fees',
  'faq.topics.pricingFeesDesc': 'Understand our transparent pricing structure and what\'s included in each service.',
  'faq.topics.certificates': 'Certificates',
  'faq.topics.certificatesDesc': 'Information about diamond certificates and how they affect valuation.',
  'faq.topics.shippingSafety': 'Shipping & Safety',
  'faq.topics.shippingSafetyDesc': 'Safe shipping practices and insurance coverage for your valuable items.',

  // FAQ Questions & Answers
  'faq.questions.valuationTime': 'How long does a diamond valuation take?',
  'faq.answers.valuationTime': 'A standard diamond valuation typically takes 3-5 business days from when we receive your item. Express services are available for urgent requests, which can be completed within 24-48 hours for an additional fee.',

  'faq.questions.informationNeeded': 'What information do I need to provide for a valuation?',
  'faq.answers.informationNeeded': 'For the most accurate valuation, please provide any existing certificates (GIA, AGS, etc.), purchase receipts, insurance documents, and detailed photos. Our online form will guide you through all the necessary information.',

  'faq.questions.valuationCost': 'How much does a diamond valuation cost?',
  'faq.answers.valuationCost': 'Our valuation fees start at $150 for standard service. Pricing varies based on the complexity of the piece, number of stones, and turnaround time. Contact us for a detailed quote based on your specific needs.',

  'faq.questions.valuationDifference': 'What\'s the difference between market value and insurance value?',
  'faq.answers.valuationDifference': 'Market value represents what you could reasonably expect to receive if selling the diamond today. Insurance value (replacement value) is typically 20-40% higher and represents the cost to replace the item with one of similar quality.',

  'faq.questions.insuranceAppraisals': 'Do you provide insurance appraisals?',
  'faq.answers.insuranceAppraisals': 'Yes, we provide certified appraisals that are accepted by all major insurance companies. Our appraisals meet industry standards and include detailed descriptions, photographs, and current market valuations.',

  'faq.questions.safeShipping': 'How do you ensure safe shipping of valuable items?',
  'faq.answers.safeShipping': 'We use fully insured, signature-required shipping with tracking. Items are packaged in discrete, secure containers. We also offer local drop-off and pickup services in major metropolitan areas.',

  'faq.questions.valueTypes': 'What types of values do you provide?',
  'faq.answers.valueTypes': 'We provide multiple valuation types including Fair Market Value, Insurance Replacement Value, Estate/Probate Value, and Liquidation Value, depending on your specific needs and intended use.',

  'faq.questions.coloredDiamonds': 'Do you appraise colored diamonds and fancy shapes?',
  'faq.answers.coloredDiamonds': 'Absolutely! Our certified gemologists have extensive experience with fancy colored diamonds, rare shapes, and unique pieces. Colored diamond valuations may require additional time due to their specialized nature.',

  'faq.questions.certificatesAccepted': 'Which diamond certificates do you accept?',
  'faq.answers.certificatesAccepted': 'We work with diamonds certified by GIA, AGS, Gübelin, SSEF, AGL, and other reputable laboratories. If your diamond lacks certification, we can arrange for professional grading as part of the valuation process.',

  'faq.questions.multipleItemsDiscount': 'Do you offer discounts for multiple items?',
  'faq.answers.multipleItemsDiscount': 'Yes, we offer volume discounts for multiple pieces. Contact us with details about your collection for a customized quote. Estate and collection appraisals receive special pricing considerations.',

  'faq.questions.trackRequest': 'How can I track my valuation request?',
  'faq.answers.trackRequest': 'Once you submit a request, you\'ll receive a tracking number and access to our client portal where you can monitor progress, communicate with your assigned gemologist, and receive updates in real-time.',

  'faq.questions.lossOrDamage': 'What happens if my item is lost or damaged during shipping?',
  'faq.answers.lossOrDamage': 'All items are fully insured during transit and while in our possession. In the unlikely event of loss or damage, our comprehensive insurance policy will provide full compensation based on the declared value.',
  ...
  'contact.description': 'Get in touch with our diamond experts for personalized assistance with valuations, purchases, or any questions about diamonds.',
  'contact.messageSent': 'Message Sent!',
  'contact.messageReceived': 'Thank you for contacting us! We\'ve received your message and will get back to you within 24 hours.',
  ...
  'contact.whatInfoAnswer': 'High-quality photos, certificates, and basic measurements help us provide accurate valuations.',
  'contact.insuranceAccepted': 'Are your appraisals accepted by insurance companies?',
  'contact.insuranceAnswer': 'Yes, our certified appraisals are accepted by all major insurance companies.',
  ...
  'auth.loginDescription': 'Sign in to your account to access your dashboard and track your valuations.',
  'auth.createAccount': 'Create Account',
  'auth.registerDescription': 'Create an account to access exclusive features and track your diamond valuation history.',
  'auth.email': 'Email',
  ...
  'communication.noMessagesDesc': 'When you receive messages from our team, they will appear here.',
  ...
  // Staff Performance Metrics (English)
  ...
  // Staff Section Headings (English)
  ...
  // Staff Email Template (English)
  'staff.emailTemplate': 'Dear',
  'staff.emailBody': 'We have completed the professional valuation of your diamond. Please find the detailed report attached.',
  'staff.emailClosing': 'Best regards',
  'staff.messageToCustomer': 'Message to Customer',
  
  // Staff Additional UI Labels (English)
  ...
  // Enhanced Staff Features (English)
  ...
  // Status translations for Work Queue
  'staff.status.newrequest': 'New Request',
  'staff.status.consultantassigned': 'Consultant Assigned',
  'staff.status.customercontacted': 'Customer Contacted',
  'staff.status.receiptcreated': 'Receipt Created',
  'staff.status.valuationassigned': 'Valuation Assigned',
  'staff.status.valuationinprogress': 'Valuation In Progress',
  'staff.status.valuationcompleted': 'Valuation Completed',
  'staff.status.consultantreview': 'Consultant Review',
  'staff.status.resultssent': 'Results Sent',
  'staff.status.completed': 'Completed',
  'staff.status.onhold': 'On Hold',
...
const viTranslations: Record<string, string> = {
  ...
  'hero.subtitle': 'Dịch vụ thẩm định kim cương chuyên nghiệp với độ chính xác và uy tín vượt trội. Khám phá giá trị thực của những viên đá quý của bạn.',
  ...
  'intro.description': 'Chúng tôi cung cấp dịch vụ thẩm định kim cương chuyên nghiệp với công nghệ tiên tiến và các chuyên gia giàu kinh nghiệm. Sứ mệnh của chúng tôi là mang đến những đánh giá chính xác, minh bạch và đáng tin cậy giúp khách hàng đưa ra quyết định sáng suốt về những viên đá quý của mình.',

  // Services
  'service.valuation.title': 'Định Giá Kim Cương',
  'service.valuation.description': 'Thẩm định kim cương chính xác sử dụng công nghệ tiên tiến và phân tích chuyên môn cho bảo hiểm, bán lại, hoặc hiểu biết cá nhân.',
  'service.certification.title': 'Chứng Nhận',
  'service.certification.description': 'Dịch vụ chứng nhận kim cương chuyên nghiệp để xác thực và ghi nhận những đặc điểm chính xác của kim cương.',
  'service.consultation.title': 'Tư Vấn Chuyên Gia',
  'service.consultation.description': 'Hướng dẫn cá nhân từ các chuyên gia kim cương giúp bạn hiểu về chất lượng và giá trị của viên đá quý.',

  // Valuation Process
  'process.title': 'Quy Trình',
  'process.titleHighlight': 'Định Giá',
  'process.description': 'Trải nghiệm quy trình hợp lý được thiết kế để mang đến định giá kim cương chính xác với thời gian chờ tối thiểu và tính minh bạch tối đa.',
  'process.step1.title': 'Gửi Yêu Cầu',
  'process.step1.description': 'Điền vào biểu mẫu trực tuyến chi tiết với thông tin về kim cương của bạn. Bao gồm càng nhiều chi tiết càng tốt như chứng nhận, nguồn gốc và đặc điểm vật lý.',
  'process.step2.title': 'Tư Vấn',
  'process.step2.description': 'Nhân viên tư vấn sẽ liên hệ với bạn để thảo luận về nhu cầu định giá và sắp xếp để kim cương được kiểm tra bởi các chuyên gia.',
  'process.step3.title': 'Định Giá Chuyên Gia',
  'process.step3.description': 'Các nhà kim cương học thực hiện phân tích toàn diện bằng thiết bị tiên tiến để đánh giá tất cả khía cạnh theo tiêu chuẩn quốc tế.',
  'process.step4.title': 'Nhận Chứng Chỉ',
  'process.step4.description': 'Nhận chứng chỉ định giá toàn diện với tất cả chi tiết về đặc điểm, chất lượng và giá trị ước tính trong điều kiện thị trường hiện tại.',
  'process.startNow': 'Bắt Đầu Định Giá Ngay',

  // Featured Diamonds
  'featured.diamonds.title': 'Kim Cương',
  'featured.diamonds.titleHighlight': 'Nổi Bật',
  'featured.diamonds.description': 'Khám phá bộ sưu tập kim cương đặc biệt của chúng tôi, mỗi viên đều có đặc điểm độc đáo và vẻ đẹp xuất sắc.',
  'featured.diamonds.carat': 'Carat',
  ...
  'knowledge.description': 'Nâng cao hiểu biết về kim cương với các bài viết, hướng dẫn và tài nguyên chuyên môn.',
  ...
  'knowledge.featuredDescription': 'Bắt đầu với những hướng dẫn cần thiết để hiểu về kim cương và định giá.',
  ...
  'cta.description': 'Bắt đầu hành trình định giá kim cương ngay hôm nay với đội ngũ chuyên gia và nhận được đánh giá toàn diện về viên đá quý của bạn.',
  'cta.getStarted': 'Bắt Đầu Ngay',

  // Footer
  'footer.description': 'Đối tác đáng tin cậy cho định giá kim cương, chứng nhận và chuyên môn trong thế giới đá quý cao cấp.',
  ...
  'footer.newsletterDescription': 'Đăng ký bản tin để nhận xu hướng kim cương mới nhất và thông tin định giá.',
  ...
  'valuation.description': 'Nhận ước tính giá trị kim cương bằng cách cung cấp đặc điểm của nó. Hoàn thành biểu mẫu dưới đây để được định giá chuyên nghiệp.',
  'valuation.step': 'Bước',
  'valuation.of': 'của',
  ...
  'step1.description': 'Nhập thông tin chứng chỉ kim cương nếu có, hoặc tiếp tục mà không cần.',
  ...
  'step1.note': 'Lưu ý: Bằng cách cung cấp số chứng chỉ, chúng tôi có thể tự động truy xuất một số thông tin, điều này sẽ giúp ích trong quá trình định giá.',
  ...
  'step3.description': 'Những đặc điểm quan trọng này ảnh hưởng đáng kể đến giá trị kim cương.',
  'step3.colorGrade': 'Cấp Độ Màu',
  'step3.clarityGrade': 'Cấp Độ Tinh Khiết',
  'step3.didYouKnow': 'Bạn có biết?',
  'step3.didYouKnowText': 'Màu sắc và độ tinh khiết là hai trong số "4 C" quyết định giá trị kim cương. Thang màu từ D (không màu) đến Z (vàng nhạt hoặc nâu nhạt), trong khi độ tinh khiết đo sự vắng mặt của tạp chất và khuyết điểm, từ Hoàn Hảo (FL) đến Có Tạp Chất (I3).',

  'step4.title': 'Đặc Điểm Cắt Gọt',
  'step4.description': 'Chất lượng cắt gọt ảnh hưởng đáng kể đến cách ánh sáng tương tác với kim cương.',
  ...
  'step5.guideTip': 'Kích thước chính xác giúp cung cấp định giá chính xác hơn, đặc biệt khi kết hợp với trọng lượng và các đặc điểm khác.',
  ...
  'step6.notesPlaceholder': 'Bất kỳ chi tiết nào khác về kim cương có thể liên quan đến định giá...',
  'step6.helpfulTip': 'Mẹo Hữu Ích',
  'step6.helpfulTipText': 'Nếu kim cương của bạn trong khung cài, chúng tôi cung cấp định giá riêng cho kim cương và khung cài. Nếu bạn muốn định giá toàn bộ món trang sức, vui lòng ghi rõ trong ghi chú bổ sung.',

  'step7.title': 'Thông Tin Liên Hệ',
  'step7.description': 'Vui lòng cung cấp thông tin liên hệ để chúng tôi có thể gửi kết quả định giá.',
  ...
  'results.noteText': 'Đây là ước tính tự động dựa trên thông tin được cung cấp. Để có định giá chính xác, chúng tôi khuyến nghị đặt lịch đánh giá trực tiếp với các nhà kim cương học chuyên nghiệp.',
  'results.summary': 'Tóm Tắt Kim Cương',
  'results.nextSteps': 'Bước Tiếp Theo',
  'results.requestSubmitted': 'Yêu cầu định giá đã được gửi thành công! Một thành viên trong đội ngũ sẽ liên hệ với bạn tại {email} trong vòng 24 giờ.',
  ...
  // Shop Page (Vietnamese)
  'shop.title': 'Bộ Sưu Tập',
  'shop.titleHighlight': 'Kim Cương',
  'shop.description': 'Khám phá bộ sưu tập kim cương và trang sức cao cấp được chứng nhận của chúng tôi, mỗi món đều được lựa chọn cẩn thận vì chất lượng và vẻ đẹp đặc biệt.',
  'shop.filters': 'Bộ Lọc',
  ...
  'shop.needHelpDesc': 'Các chuyên gia kim cương của chúng tôi sẵn sàng giúp bạn tìm món trang sức hoàn hảo. Nhận tư vấn cá nhân và hướng dẫn chuyên nghiệp.',
  'shop.getValuation': 'Nhận Định Giá',
  'shop.contactExpert': 'Liên Hệ Chuyên Gia',

  // Cart Page (Vietnamese)
  'cart.title': 'Giỏ',
  ...
  'placeholder.handlingInstructions': 'Hướng dẫn xử lý đặc biệt hoặc ghi chú cho nhân viên định giá...',
  ...
  // Checkout placeholders (Vietnamese)
  'placeholder.cardNumber': '1234 5678 9012 3456',
  'placeholder.expiryDate': 'MM/YY',
  'placeholder.cvv': '123',
  ...
  'faq.description': 'Tìm câu trả lời cho các câu hỏi thường gặp về định giá kim cương, dịch vụ của chúng tôi và quy trình thẩm định.',
  ...
  'faq.diamondGradingDesc': 'Tìm hiểu về 4C và cách chúng tôi đánh giá chất lượng và đặc điểm kim cương.',
  'faq.pricingFeesDesc': 'Hiểu về cấu trúc giá minh bạch và những gì được bao gồm trong mỗi dịch vụ.',
  'faq.certificatesDesc': 'Thông tin về chứng nhận kim cương và cách chúng ảnh hưởng đến định giá.',
  'faq.shippingSafetyDesc': 'Thực hành vận chuyển an toàn và bảo hiểm cho các vật phẩm có giá trị.',
  'faq.viewQuestions': 'Xem câu hỏi →',
  'faq.readyToStart': 'Sẵn Sàng Bắt Đầu?',
  'faq.readyToStartDesc': 'Nếu bạn không tìm thấy câu trả lời mình tìm kiếm, đội ngũ chuyên gia của chúng tôi sẵn sàng hỗ trợ bạn một cách cá nhân.',
  'faq.startValuation': 'Bắt Đầu Định Giá',
  'faq.contactSupport': 'Liên Hệ Hỗ Trợ',

  // FAQ Categories (Vietnamese)
  ...
  // FAQ Topics (Vietnamese)
  'faq.topics.diamondGrading': 'Phân Loại Kim Cương',
  'faq.topics.diamondGradingDesc': 'Tìm hiểu về 4C và cách chúng tôi đánh giá chất lượng và đặc điểm kim cương.',
  'faq.topics.pricingFees': 'Giá & Phí',
  'faq.topics.pricingFeesDesc': 'Hiểu về cấu trúc giá minh bạch và những gì được bao gồm trong mỗi dịch vụ.',
  'faq.topics.certificates': 'Chứng Nhận',
  'faq.topics.certificatesDesc': 'Thông tin về chứng nhận kim cương và cách chúng ảnh hưởng đến định giá.',
  'faq.topics.shippingSafety': 'Vận Chuyển & An Toàn',
  'faq.topics.shippingSafetyDesc': 'Thực hành vận chuyển an toàn và bảo hiểm cho các vật phẩm có giá trị.',

  // FAQ Questions & Answers (Vietnamese)
  'faq.questions.valuationTime': 'Việc định giá kim cương mất bao lâu?',
  'faq.answers.valuationTime': 'Một việc định giá kim cương tiêu chuẩn thường mất 3-5 ngày làm việc kể từ khi chúng tôi nhận được món đồ của bạn. Dịch vụ nhanh có sẵn cho các yêu cầu khẩn cấp, có thể hoàn thành trong vòng 24-48 giờ với phí bổ sung.',

  'faq.questions.informationNeeded': 'Tôi cần cung cấp thông tin gì để định giá?',
  'faq.answers.informationNeeded': 'Để có được định giá chính xác nhất, vui lòng cung cấp bất kỳ chứng nhận hiện có (GIA, AGS, v.v.), hóa đơn mua hàng, tài liệu bảo hiểm và ảnh chi tiết. Biểu mẫu trực tuyến của chúng tôi sẽ hướng dẫn bạn qua tất cả thông tin cần thiết.',

  'faq.questions.valuationCost': 'Việc định giá kim cương có giá bao nhiêu?',
  'faq.answers.valuationCost': 'Phí định giá của chúng tôi bắt đầu từ $150 cho dịch vụ tiêu chuẩn. Giá cả thay đổi dựa trên độ phức tạp của món đồ, số lượng viên đá và thời gian hoàn thành. Liên hệ với chúng tôi để có báo giá chi tiết dựa trên nhu cầu cụ thể của bạn.',

  'faq.questions.valuationDifference': 'Sự khác biệt giữa giá trị thị trường và giá trị bảo hiểm là gì?',
  'faq.answers.valuationDifference': 'Giá trị thị trường đại diện cho những gì bạn có thể mong đợi nhận được nếu bán kim cương ngày hôm nay. Giá trị bảo hiểm (giá trị thay thế) thường cao hơn 20-40% và đại diện cho chi phí để thay thế món đồ bằng một món có chất lượng tương tự.',

  'faq.questions.insuranceAppraisals': 'Bạn có cung cấp thẩm định bảo hiểm không?',
  'faq.answers.insuranceAppraisals': 'Có, chúng tôi cung cấp thẩm định được chứng nhận được chấp nhận bởi tất cả các công ty bảo hiểm lớn. Thẩm định của chúng tôi đáp ứng tiêu chuẩn ngành và bao gồm mô tả chi tiết, ảnh chụp và định giá thị trường hiện tại.',

  'faq.questions.safeShipping': 'Bạn đảm bảo vận chuyển an toàn các vật phẩm có giá trị như thế nào?',
  'faq.answers.safeShipping': 'Chúng tôi sử dụng vận chuyển được bảo hiểm đầy đủ, yêu cầu chữ ký với theo dõi. Các món đồ được đóng gói trong thùng chứa kín đáo, an toàn. Chúng tôi cũng cung cấp dịch vụ giao nhận tại chỗ ở các khu vực đô thị lớn.',

  'faq.questions.valueTypes': 'Bạn cung cấp những loại giá trị nào?',
  'faq.answers.valueTypes': 'Chúng tôi cung cấp nhiều loại định giá bao gồm Giá Trị Thị Trường Công Bằng, Giá Trị Thay Thế Bảo Hiểm, Giá Trị Di Sản/Thừa Kế và Giá Trị Thanh Lý, tùy thuộc vào nhu cầu cụ thể và mục đích sử dụng của bạn.',

  'faq.questions.coloredDiamonds': 'Bạn có thẩm định kim cương màu và hình dạng đặc biệt không?',
  'faq.answers.coloredDiamonds': 'Hoàn toàn có! Các chuyên gia đá quý được chứng nhận của chúng tôi có kinh nghiệm phong phú với kim cương màu đặc biệt, hình dạng hiếm và các món đồ độc đáo. Định giá kim cương màu có thể cần thêm thời gian do tính chất chuyên biệt.',

  'faq.questions.certificatesAccepted': 'Bạn chấp nhận những chứng nhận kim cương nào?',
  'faq.answers.certificatesAccepted': 'Chúng tôi làm việc với kim cương được chứng nhận bởi GIA, AGS, Gübelin, SSEF, AGL và các phòng thí nghiệm uy tín khác. Nếu kim cương của bạn thiếu chứng nhận, chúng tôi có thể sắp xếp phân loại chuyên nghiệp như một phần của quy trình định giá.',

  'faq.questions.multipleItemsDiscount': 'Bạn có giảm giá cho nhiều món đồ không?',
  'faq.answers.multipleItemsDiscount': 'Có, chúng tôi cung cấp giảm giá số lượng cho nhiều món đồ. Liên hệ với chúng tôi với chi tiết về bộ sưu tập của bạn để có báo giá tùy chỉnh. Thẩm định di sản và bộ sưu tập nhận được cân nhắc giá đặc biệt.',

  'faq.questions.trackRequest': 'Làm thế nào tôi có thể theo dõi yêu cầu định giá của mình?',
  'faq.answers.trackRequest': 'Sau khi bạn gửi yêu cầu, bạn sẽ nhận được số theo dõi và quyền truy cập vào cổng khách hàng nơi bạn có thể theo dõi tiến độ, giao tiếp với chuyên gia đá quý được phân công và nhận cập nhật theo thời gian thực.',

  'faq.questions.lossOrDamage': 'Điều gì xảy ra nếu món đồ của tôi bị mất hoặc hư hỏng trong quá trình vận chuyển?',
  'faq.answers.lossOrDamage': 'Tất cả các món đồ được bảo hiểm đầy đủ trong quá trình vận chuyển và khi đang trong sự bảo quản của chúng tôi. Trong trường hợp không may mất mát hoặc hư hỏng, chính sách bảo hiểm toàn diện của chúng tôi sẽ cung cấp bồi thường đầy đủ dựa trên giá trị khai báo.',

  // Checkout Page (Vietnamese)
  ...
  'contact.description': 'Liên hệ với các chuyên gia kim cương của chúng tôi để được hỗ trợ cá nhân về định giá, mua hàng hoặc bất kỳ câu hỏi nào về kim cương.',
  'contact.messageSent': 'Tin Nhắn Đã Gửi!',
  'contact.messageReceived': 'Cảm ơn bạn đã liên hệ với chúng tôi! Chúng tôi đã nhận được tin nhắn và sẽ phản hồi trong vòng 24 giờ.',
  ...
  'contact.whatInfoAnswer': 'Ảnh chất lượng cao, chứng chỉ và kích thước cơ bản giúp chúng tôi cung cấp định giá chính xác.',
  'contact.insuranceAccepted': 'Định giá của bạn có được các công ty bảo hiểm chấp nhận không?',
  'contact.insuranceAnswer': 'Có, định giá được chứng nhận của chúng tôi được tất cả các công ty bảo hiểm lớn chấp nhận.',
  'contact.viewCredentials': 'Xem thông tin chứng nhận →',

  // Product Detail Page (Vietnamese)
  ...
  'auth.loginDescription': 'Đăng nhập vào tài khoản của bạn để truy cập bảng điều khiển và theo dõi các định giá của bạn.',
  'auth.createAccount': 'Tạo Tài Khoản',
  'auth.registerDescription': 'Tạo tài khoản để truy cập các tính năng độc quyền và theo dõi lịch sử định giá kim cương của bạn.',
  'auth.email': 'Email',
  ...
  // System Configuration (Vietnamese)
  ...
  // User Management Details (Vietnamese)
  ...
  // System Configuration Details (Vietnamese)
  ...
  // Staff Dashboard Stats (Vietnamese)
  ...
  // Staff Dashboard Content (Vietnamese)
  ...
  // Staff Status Labels (Vietnamese)
  ...
  'staff.quickActions': 'Hành Động Nhanh',
  ...
  'staff.diamondSpecifications': 'Thông Số Kim Cương',
  ...
  'staff.saveProgress': 'Lưu Tiến Độ',
  ...
  // Staff Dashboard Section Headings (Vietnamese)
  ...
  // Staff Dashboard Button Actions (Vietnamese)
  ...
  // Staff Email Template (Vietnamese)
  'staff.emailTemplate': 'Kính chào',
  'staff.emailBody': 'Chúng tôi đã hoàn thành việc thẩm định chuyên nghiệp cho viên kim cương của bạn. Vui lòng tìm báo cáo chi tiết trong tệp đính kèm.',
  'staff.emailClosing': 'Trân trọng',
  'staff.messageToCustomer': 'Tin Nhắn Gửi Khách Hàng',
  
  // Staff Additional UI Labels (Vietnamese)
  ...
  // Dashboard Pages (Vietnamese)
  'dashboard.welcome': 'Chào mừng trở lại',
  'dashboard.subtitle': 'Quản lý tài khoản, đơn hàng và định giá của bạn',
  ...
  'dashboard.valuationRequests': 'Yêu Cầu Định Giá',
  ...
  'communication.subject': 'Tiêu Đề',
  'communication.message': 'Tin Nhắn',
  'communication.requestId': 'Mã Yêu Cầu Liên Quan',
  'communication.send': 'Gửi Tin Nhắn',
  'communication.cancel': 'Hủy',
  'communication.noMessages': 'Chưa có tin nhắn',
  'communication.noMessagesDesc': 'Khi bạn nhận được tin nhắn từ đội ngũ của chúng tôi, chúng sẽ xuất hiện tại đây.',
  ...
  // Valuation Results (Vietnamese)
  'valuation.results': 'Kết Quả Định Giá',
  'valuation.summary': 'Tóm Tắt',
  'valuation.detailed': 'Báo Cáo Chi Tiết',
  'valuation.certificate': 'Giấy Chứng Nhận',
  'valuation.marketValue': 'Giá Trị Thị Trường',
  'valuation.insuranceValue': 'Giá Trị Bảo Hiểm',
  'valuation.retailValue': 'Giá Trị Bán Lẻ',
  'valuation.condition': 'Tình Trạng',
  'valuation.methodology': 'Phương Pháp Định Giá',
  'valuation.diamondDetails': 'Chi Tiết Kim Cương',
  'valuation.shape': 'Hình Dạng',
  'valuation.caratWeight': 'Trọng Lượng Carat',
  'valuation.color': 'Màu Sắc',
  'valuation.clarity': 'Độ Trong',
  'valuation.cut': 'Giác Cắt',
  'valuation.polish': 'Độ Bóng',
  'valuation.symmetry': 'Độ Đối Xứng',
  'valuation.fluorescence': 'Huỳnh Quang',
  'valuation.measurements': 'Kích Thước',
  'valuation.certificateNumber': 'Số Giấy Chứng Nhận',
  'valuation.certificateType': 'Loại Giấy Chứng Nhận',
  'valuation.submittedDate': 'Ngày Gửi',
  'valuation.completedDate': 'Ngày Hoàn Thành',
  'valuation.consultantName': 'Tên Tư Vấn Viên',
  'valuation.valuationStaff': 'Nhân Viên Định Giá',
  'valuation.receiptNumber': 'Số Biên Lai',
  'valuation.downloadReport': 'Tải Báo Cáo',
  'valuation.printCertificate': 'In Giấy Chứng Nhận',
  'valuation.requestNew': 'Yêu Cầu Định Giá Mới',
};
