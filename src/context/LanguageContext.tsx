...
interface LanguageContextType {
  ...
  formatMoney: (
    amountUSD: number,
    opts?: { currency?: Currency; noConvert?: boolean }
  ) => string;
...
const enTranslations: Record<string, string> = {
  ...
  // --- Admin Product table & filters (VI)
  "common.add": "Thêm",
  "common.prev": "Trước",
  ...
  "admin.sortPriceAsc": "Price: Low → High",
  "admin.sortPriceDesc": "Price: High → Low",
  "admin.sortStockAsc": "Stock: Low → High",
  "admin.sortStockDesc": "Stock: High → Low",

  "admin.archive": "Lưu trữ",
  ...
  "placeholder.contactOutcome":
    "Record the outcome of your customer contact...",
  ...
  "placeholder.certificationDetails":
    "GIA/AGS certification number, details...",
  "placeholder.detailedAnalysis":
    "Detailed analysis, observations, methodology used...",
  ...
  "placeholder.orderNotes":
    "Any special delivery instructions or gift message...",
  ...
  "faq.questions.multipleItemsDiscount":
  ...
  "admin.thisActionCannotBeUndone": "This action cannot be undone.",
  // Admin Dashboard (EN)
  ...
  "staff.diamondSpecifications": "Diamond Specifications",
  ...
  "staff.waitingDeliveryConfirmation":
    "Waiting for diamond delivery confirmation",
...
const viTranslations: Record<string, string> = {
  ...
  "knowledge.searchPlaceholder":
    "Tìm kiếm bài viết, hướng dẫn và thông tin chuyên sâu...",
  ...
  "footer.copyright":
    "© {year} Hệ Thống Định Giá Kim Cương. Tất cả quyền được bảo lưu.",
  ...
  "step2.description":
    "Cho chúng tôi biết về các thuộc tính cơ bản của kim cương.",
  ...
  "step5.description":
    "Nếu biết, vui lòng cung cấp kích thước vật lý của kim cương.",
  ...
  "step6.description":
    "Bất kỳ chi tiết nào khác có thể ảnh hưởng đến định giá kim cương.",
  ...
  "cart.emptyDesc":
    "Khám phá bộ sưu tập kim cương và trang sức tuyệt đẹp của chúng tôi.",
  ...
  "admin.allStatuses": "Tất cả trạng thái",
  "admin.sortNewest": "Mới nhất",
  "admin.sortOldest": "Cũ nhất",
  "admin.sortNameAsc": "Tên: A → Z",
  "admin.sortNameDesc": "Tên: Z → A",
  "admin.sortPriceAsc": "Giá: Thấp → Cao",
  "admin.sortPriceDesc": "Giá: Cao → Thấp",
  "admin.sortStockAsc": "Tồn kho: Thấp → Cao",
  "admin.sortStockDesc": "Tồn kho: Cao → Thấp",

  "admin.newProduct": "Sản phẩm mới",
  "admin.name": "Tên",
  "admin.sku": "SKU",
  "admin.imageUrl": "URL Ảnh",
  "admin.status.active": "Hoạt động",
  "admin.status.inactive": "Ngưng hoạt động",
  ...
  "placeholder.detailedAnalysis":
    "Phân tích chi tiết, quan sát, phương pháp sử dụng...",
  ...
  "placeholder.cvv": "123",
  "placeholder.orderNotes":
    "Hướng dẫn giao hàng đặc biệt hoặc tin nhắn quà tặng...",
  ...
  "faq.noResultsDesc":
    "Thử điều chỉnh thuật ngữ tìm kiếm hoặc duyệt các danh mục khác.",
  ...
  "faq.questions.informationNeeded":
    "Tôi cần cung cấp thông tin gì để định giá?",
  "faq.answers.informationNeeded":
  ...
  "faq.questions.insuranceAppraisals":
    "Bạn có cung cấp thẩm định bảo hiểm không?",
  "faq.answers.insuranceAppraisals":
  ...
  "faq.questions.safeShipping":
    "Bạn đảm bảo vận chuyển an toàn các vật phẩm có giá trị như thế nào?",
  "faq.answers.safeShipping":
  ...
  "faq.questions.certificatesAccepted":
    "Bạn chấp nhận những chứng nhận kim cương nào?",
  "faq.answers.certificatesAccepted":
  ...
  "faq.questions.multipleItemsDiscount":
    "Bạn có giảm giá cho nhiều món đồ không?",
  "faq.answers.multipleItemsDiscount":
  ...
  "faq.questions.trackRequest":
    "Làm thế nào tôi có thể theo dõi yêu cầu định giá của mình?",
  "faq.answers.trackRequest":
  ...
  "faq.questions.lossOrDamage":
    "Điều gì xảy ra nếu món đồ của tôi bị mất hoặc hư hỏng trong quá trình vận chuyển?",
  "faq.answers.lossOrDamage":
  ...
  "contact.howLongAnswer":
    "Hầu hết các định giá được hoàn thành trong vòng 3-5 ngày làm việc kể từ khi nhận.",
  ...
  "contact.insuranceAccepted":
    "Định giá của bạn có được các công ty bảo hiểm chấp nhận không?",
  "contact.insuranceAnswer":
  ...
  "admin.thisActionCannotBeUndone": "Hành động này không thể hoàn tác.",
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  // --- NEW: tỷ giá & tiền tệ ---
  // Lấy tỉ giá từ ENV nếu có, mặc định 25,000
  const ENV_RATE = Number((import.meta as any).env?.VITE_USD_VND_RATE);
  const [rates] = useState<{ USD: number; VND: number }>({
    USD: 1,
    VND: Number.isFinite(ENV_RATE) && ENV_RATE > 0 ? ENV_RATE : 25000,
  });

  // Tiền tệ tự sync theo ngôn ngữ: vi -> VND, en -> USD
  ...
  useEffect(() => {
    ...
    setCurrency(language === "vi" ? "VND" : "USD");
  }, [language]);
  ...
  // amountUSD: giá trị gốc theo USD
  const convert = (amountUSD: number, to: Currency = currency): number => {
    const rate = to === "USD" ? rates.USD : rates.VND;
  ...
  const formatMoney = (
    ...
    const value = opts?.noConvert ? amountUSD : convert(amountUSD, cur);
    const maximumFractionDigits = cur === "VND" ? 0 : 2;
