...
const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Map sang payload BE
    const payload = {
      userName: formData.email.split("@")[0], // hoặc cho user nhập riêng
      email: formData.email,
      password: formData.password,
      fullName: `${formData.firstName} ${formData.lastName}`.trim(),
      // phone/newsletter không có trong API register hiện tại → bỏ qua
    };
    ...
    try {
      ...
      // Auto-login bằng access/refresh token
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <label
                    ...
                    className="ml-2 block text-sm text-gray-700"
                  >
                    Subscribe to our newsletter for exclusive offers and diamond
                    insights
                  </label>
                </div>
              </div>
          ...
          {/* Social Login (giữ nguyên UI – chưa nối OAuth) */}
