    ...
    switch (action) {
      ...
      case "suspend":
        if (confirm("Are you sure you want to suspend this user?")) {
          setUsers((prev) =>
            prev.map((u) =>
              u.id === Number(userId) ? { ...u, status: "suspended" } : u
            )
          );
      ...
      case "activate":
        setUsers((prev) =>
          prev.map((u) =>
            u.id.toString() === userId ? { ...u, status: "active" } : u
          )
        );
      ...
      case "bulk_action":
        if (selectedUsers.length > 0) {
          ...
          if (
            ...
            setUsers((prev) =>
              prev.filter((u) => !selectedUsers.includes(u.id.toString()))
            );
            setSelectedUsers([]);
                    ...
                    >
                      ...
                      <div className="text-left">
                        <p className="font-medium">
                          {t("admin.valuationQueue")}
                        </p>
                        <p className="text-sm opacity-75">
                          {t("admin.monitorPending")}
                        </p>
                      </div>
                    </button>
                    <button
                        ...
                        <th className="px-4 py-3 text-left font-medium text-gray-700">
                          <input
                            ...
                            onChange={(e) => {
                              if (e.target.checked) {
                                setSelectedUsers(
                                  filteredUsers.map((u) => u.id.toString())
                                );
                              } else {
                                setSelectedUsers([]);
                              }
                        ...
                        <tr key={user.id.toString()}>
                          ...
                          <td className="px-4 py-3">
                            <div className="flex space-x-2">
                              <button
                                onClick={() =>
                                  handleUserAction("edit", user.id.toString())
                                }
                          ...
                          <tr key={order.id}>
                            ...
                            <td className="px-4 py-3">
                              <div className="flex space-x-2">
                                <button
                                  onClick={() =>
                                    handleOrderAction("view", order.id)
                                  }
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <div className="grid md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-blue-50 p-4 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-blue-900">
                        {
                          staff.filter((s) => s.role === "consulting_staff")
                            .length
                        }
                      </p>
                    </div>
                    <div className="bg-purple-50 p-4 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-purple-900">
                        {
                          staff.filter((s) => s.role === "valuation_staff")
                            .length
                        }
                      </p>
                    </div>
                        ...
                        {staff.map((staffMember) => (
                          <tr key={staffMember.id}>
                            ...
                            <td className="px-4 py-3">
                              <span
                                className={`px-2 py-1 rounded-full text-xs ${
                                  staffMember.role === "valuation_staff"
                                    ? "bg-purple-100 text-purple-800"
                                    : staffMember.role === "consulting_staff"
                                    ? "bg-blue-100 text-blue-800"
                                    : "bg-green-100 text-green-800"
                                }`}
                              >
                            ...
                            <td className="px-4 py-3">
                              <div className="flex space-x-2">
                                <button
                                  onClick={() =>
                                    handleStaffAction("view", staffMember.id)
                                  }
                                  className="text-blue-600 hover:text-blue-800"
                                >
                                  View
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-4 border rounded-lg">
                      ...
                      <div className="h-48 bg-gray-100 rounded flex items-center justify-center">
                        <p className="text-gray-500">
                          {t("placeholder.revenueChart")}
                        </p>
                      </div>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-4">
                        {t("admin.customerAcquisition")}
                      </h4>
                      <div className="h-48 bg-gray-100 rounded flex items-center justify-center">
                        <p className="text-gray-500">
                          {t("placeholder.customerChart")}
                        </p>
                      </div>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-medium mb-4">
                        {t("admin.productPerformance")}
                      </h4>
                      <div className="space-y-2">
                ...
                <div className="space-y-4">
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="mt-1 w-full px-3 py-2 border rounded-md"
                        >
                          <option value="Insurance Appraisal">
                            Insurance Appraisal
                          </option>
                          <option value="Market Valuation">
                            Market Valuation
                          </option>
                          <option value="Estate Valuation">
                            Estate Valuation
                          </option>
                        </select>
                      </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Dr. Emma Wilson">
                        Dr. Emma Wilson (Valuation)
                      </option>
                      <option value="James Rodriguez">
                        James Rodriguez (Valuation)
                      </option>
