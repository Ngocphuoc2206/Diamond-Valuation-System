import type { Article, Diamond, Product, User, ValuationRequest } from '../types';
...
export const diamonds: Diamond[] = [
  {
    ...
    description: 'This exceptional round brilliant diamond features outstanding fire and brilliance. With D color and VVS1 clarity, it represents the pinnacle of diamond quality.',
    featured: true,
  },
  {
    id: '2',
    ...
    description: 'This stunning princess cut diamond showcases exceptional brilliance and fire. Its precise cut maximizes light performance, creating a mesmerizing display.',
    featured: true,
  },
  {
    id: '3',
    ...
    description: 'This sophisticated emerald cut diamond offers elegant step facets that create a hall-of-mirrors effect. Its clarity is emphasized by the open table, showcasing remarkable transparency.',
    featured: false,
  },
  {
    id: '4',
    ...
    description: 'This flawless oval diamond represents the pinnacle of diamond perfection. With no inclusions or blemishes even under 10x magnification, it offers incomparable brilliance.',
    featured: true,
  },
];
...
export const products: Product[] = [
  {
    ...
    price: 5999,
    category: 'Rings',
    description: 'A timeless classic featuring a stunning round brilliant diamond set in 18k white gold.',
    images: [
  ...
  },
  {
    ...
    price: 3299,
    category: 'Pendants',
    description: 'Elegant pendant featuring a round center diamond surrounded by a halo of smaller diamonds, set in 14k rose gold.',
    images: [
  ...
  },
  {
    ...
    price: 8499,
    category: 'Bracelets',
    description: 'Stunning tennis bracelet featuring 36 round brilliant diamonds totaling 5 carats, set in platinum.',
    images: [
  ...
  },
  {
    ...
    price: 7299,
    category: 'Rings',
    description: 'Symbolizing your past, present, and future, this ring features three beautiful diamonds set in 18k yellow gold.',
    images: [
...
export const articles: Article[] = [
  {
    id: '1',
    title: '4 chữ C của chất lượng kim cương',
    excerpt: 'Understanding the crucial factors that determine a diamond\'s value: Cut, Color, Clarity, and Carat Weight.',
    summary: 'Tìm hiểu về bốn đặc điểm chính quyết định chất lượng và giá trị của kim cương: Kiểu cắt, Màu sắc, Độ tinh khiết và Trọng lượng carat.',
    content: "Diamonds are evaluated based on four key characteristics, known as the 4 Cs: Cut, Color, Clarity, and Carat Weight. The Cut refers to how well a diamond has been shaped and faceted, affecting its brilliance and fire. Color is graded on a scale from D (colorless) to Z (light yellow or brown). Clarity measures the absence of inclusions and blemishes. Finally, Carat Weight measures the diamond's size. Together, these factors determine a diamond's overall quality and value.",
    author: 'Dr. Emily Reynolds',
    publishDate: '2025-06-15T12:00:00Z',
    category: 'basics',
    tags: ['4Cs', 'Diamond Quality', 'Beginner Guide'],
    featuredImage: 'https://image.brilliantearth.com/cdn-cgi/image/width=2880,height=700,quality=100,format=auto/https://cdn.builder.io/api/v1/image/assets%2F9f2a69003c86470ea05deb9ecb9887be%2F81b842e05dfb4f179a89510bf7efca54',
    featured: true,
    readTime: '5 min read',
    externalUrl: 'https://www.brilliantearth.com/diamond/buying-guide/'
    
  },
  {
    id: '2',
    title: 'Hình dạng kim cương: Vượt ra ngoài hình tròn rực rỡ',
    excerpt: 'Explore the diverse world of diamond shapes and discover which one matches your personality.',
    summary: 'Khám phá nhiều hình dạng kim cương khác nhau và tìm hiểu hình dạng nào phù hợp nhất với phong cách và sở thích của bạn.',
    content: "While round brilliant diamonds are the most popular choice, there's a wide variety of shapes to consider. Princess cuts offer contemporary elegance with their square shape and brilliant faceting. Emerald cuts provide sophisticated vintage appeal with their step-cut facets. Oval diamonds combine the fire of round brilliants with an elongated shape that can make fingers appear slimmer. Other popular shapes include cushion, pear, marquise, radiant, asscher, and heart. Each shape has unique characteristics that affect both appearance and value.",
    author: 'Marcus Chen',
    publishDate: '2025-07-01T12:00:00Z',
    category: 'basics',
    tags: ['Diamond Shapes', 'Buying Guide'],
    featuredImage: 'https://tahigems.com/wp-content/uploads/2022/04/nhan_daquy-07112e2e8ab62e8ad4afc74187239fa0.jpg',
    featured: false,
    readTime: '7 min read',
    externalUrl: 'https://tahigems.com/tim-hieu-ve-hinh-dang-cua-kim-cuong-20133.html'

  },
  {
    id: '3',
    title: 'Giấy chứng nhận kim cương: Tại sao chúng quan trọng',
    excerpt: 'Learn why diamond certification is essential and how to read a diamond grading report.',
    summary: 'Hiểu được tầm quan trọng của chứng chỉ kim cương và tìm hiểu cách giải thích báo cáo phân loại từ các phòng thí nghiệm lớn.',
    content: "Diamond certificates, also known as grading reports, are documents issued by gemological laboratories that evaluate and describe a diamond's characteristics. These reports provide an objective assessment of the diamond's quality based on the 4 Cs and other attributes. Leading laboratories include the Gemological Institute of America (GIA), American Gem Society (AGS), and International Gemological Institute (IGI). A certificate ensures that you're getting exactly what you pay for and serves as proof of the diamond's quality. Always request a certificate when purchasing a diamond, especially for significant investments.",
    author: 'Sophia Martinez',
    publishDate: '2025-07-18T12:00:00Z',
    category: 'certification',
    tags: ['Diamond Certificates', 'GIA', 'Diamond Buying'],
    featuredImage: 'https://file.hstatic.net/200000355853/file/kiem-dinh-kim-cuong-gia-giv-nhung-dieu-ban-phai-biet-1-685x400.jpg',
    featured: true,
    readTime: '6 min read',
  },
  {
    id: '4',
    title: 'Chăm sóc và bảo trì kim cương',
    excerpt: 'Essential tips to keep your diamonds sparkling for generations.',
    summary: 'Tìm hiểu các kỹ thuật chăm sóc kim cương đúng cách để duy trì độ sáng bóng và đảm bảo kim cương của bạn tồn tại qua nhiều thế hệ.',
    content: "Diamonds may be the hardest natural substance, but they still require proper care to maintain their brilliance. Regular cleaning is essential—a simple solution of mild dish soap and warm water, along with a soft toothbrush, can remove everyday grime. For deeper cleaning, professional services are recommended every six months. Store your diamonds separately from other jewelry to prevent scratching. Remove diamond jewelry before engaging in heavy physical activities or using household chemicals. With proper care, your diamonds will remain brilliant for generations to come.",
    author: 'James Wilson',
    publishDate: '2025-08-01T12:00:00Z',
    category: 'care',
    tags: ['Diamond Care', 'Maintenance', 'Cleaning'],
    featuredImage: 'https://images.unsplash.com/photo-1601121141461-9d6647bca1ed?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGRpYW1vbmR8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60',
    featured: false,
    readTime: '4 min read',
  },
  {
    id: '5',
    title: 'Hướng dẫn đầu tư kim cương',
    excerpt: 'Understanding diamonds as investment assets and market trends.',
    summary: 'Khám phá tiềm năng của kim cương như một phương tiện đầu tư và tìm hiểu về các yếu tố thị trường ảnh hưởng đến giá trị.',
    content: "Investing in diamonds requires careful consideration of several factors. Unlike stocks or bonds, diamonds are physical assets that don't generate income but can appreciate in value over time. Investment-grade diamonds typically have exceptional characteristics: high color grades (D-F), excellent clarity (FL-VVS2), ideal cuts, and significant carat weights (2+ carats). Market trends, rarity, and economic conditions all influence diamond values. While diamonds can be part of a diversified portfolio, they should be considered long-term investments due to market illiquidity and transaction costs.",
    author: 'Robert Kim',
    publishDate: '2025-08-05T12:00:00Z',
    category: 'investment',
    tags: ['Diamond Investment', 'Market Trends', 'Asset Diversification'],
    featuredImage: 'https://images.unsplash.com/photo-1573408301185-9146fe634ad0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGRpYW1vbmR8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60',
    featured: false,
    readTime: '8 min read',
  },
  {
    id: '6',
    title: 'Hiểu về các phương pháp định giá kim cương',
    excerpt: 'How professionals determine the value of your diamonds.',
    summary: 'Tìm hiểu về các phương pháp khác nhau được các chuyên gia sử dụng để đánh giá chính xác giá trị kim cương và giá trị thị trường.',
    content: "Diamond valuation is a complex process that combines scientific assessment with market analysis. Professional valuers consider the 4 Cs, fluorescence, polish, symmetry, and current market conditions. Three main approaches are used: the cost approach (replacement cost), the market approach (comparable sales), and the income approach (for investment diamonds). Factors like origin, historical significance, and setting also influence value. Understanding these methods helps you better appreciate your diamond's worth and make informed decisions about insurance, sales, or purchases.",
    author: 'Dr. Emily Reynolds',
    publishDate: '2025-08-08T12:00:00Z',
    category: 'valuation',
    tags: ['Diamond Valuation', 'Professional Assessment', 'Market Analysis'],
    featuredImage: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGRpYW1vbmR8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60',
    featured: true,
...
export const dashboardStats = {
  ...
  revenue: {
    total: 287500,
    monthly: [22500, 24800, 21900, 25600, 23700, 26800, 28900, 27500, 29800, 30200, 31500, 32700],
  },
  customerRatings: 4.8,
